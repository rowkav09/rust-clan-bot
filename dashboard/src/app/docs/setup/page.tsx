            ...
            <aside className="hidden lg:block w-56 shrink-0">
              <div className="sticky top-24">
                ...
                <div className="mt-8 pt-6 border-t border-dark-400">
                  ...
                  <a href="https://discord.gg/placeholder" target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 text-sm text-gray-400 hover:text-white transition-colors">
            ...
            <main className="flex-1 min-w-0 max-w-3xl">
              ...
              <section className="mb-12 space-y-0">
                ...
                <Step n={1} title="Invite the bot to your server">
                  ...
                  <a href="https://discord.com/api/oauth2/authorize?client_id=YOUR_CLIENT_ID&permissions=8&scope=bot+applications.commands" target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-2 text-rust-400 hover:text-rust-300 text-sm font-medium mt-2">
